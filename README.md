...
- [Types](#types)
- [Functions](#functions)
- [minCostFlow(graph, desiredFlow) ⇒ Array.&lt;Required.&lt;Edge&gt;&gt;](#mincostflowgraph-desiredflow-%E2%87%92-arrayltrequiredltedgegtgt)
- [cheapestPaths(adjacency, capacity, cost) ⇒ Object](#cheapestpathsadjacency-capacity-cost-%E2%87%92-object)
- [currentFlow(graph) ⇒ number](#currentflowgraph-%E2%87%92-number)
- [currentCost(graph) ⇒ number](#currentcostgraph-%E2%87%92-number)
